...
function Contact() {
  ...
  return (
    <section ref={sectionRef} id="contact" className="reveal-section bg-slate-900 py-20 text-slate-50">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mb-10 space-y-3 text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-deep-red">Contact</p>
          <h2 className="font-heading text-3xl font-bold md:text-4xl">Let&apos;s design your security brief.</h2>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <div className="space-y-4 text-sm text-slate-200">
            <p className="font-semibold text-slate-50">Charis Eagle Group Ltd</p>
            <p>Nairobi, Kenya</p>
            <p>Phone: +254 XXX XXX XXX</p>
            <p>Email: info@chariseaglegroup.com</p>
          </div>
          <form className="space-y-4 rounded-3xl border border-slate-700 bg-slate-900/60 p-6 shadow-soft-lg">
            <div>
              ...
              <input
                type="text"
                className="mt-1 w-full rounded-xl border border-slate-700 bg-slate-900 px-3 py-2 text-sm text-slate-50 focus:border-deep-red focus:outline-none"
                required
              />
            </div>
            <div>
